...
{
    /// <inheritdoc />
    public partial class ServiceImp : ICardSavrProviderServiceServiceContract
    {
        ...
        public async Task<SettingsResponse> GetSettingsAsync(GetSettingsRequest request)
        {
            ...
            Logger.Trace($"{nameof(GetSettingsAsync)} | Cardsavr URL: [{cardsavrUrl}] | Integrator Name: [{cardsavrUrl}] | Integrator Key : [{integratorKey}] | | Integrator Key : [{custAgentUsername}]");
