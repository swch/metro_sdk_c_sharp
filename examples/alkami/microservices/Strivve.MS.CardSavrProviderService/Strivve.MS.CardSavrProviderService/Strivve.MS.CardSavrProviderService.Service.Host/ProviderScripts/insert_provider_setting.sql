...
declare @providerName nvarchar(50) = 'Strivve.MS.CardSavrProviderService'
declare @providerDescription nvarchar(100) = 'Strivve CardSavrProviderService'
...
select * from core.item where [Name] = 'Strivve.MS.CardSavrProviderService';
