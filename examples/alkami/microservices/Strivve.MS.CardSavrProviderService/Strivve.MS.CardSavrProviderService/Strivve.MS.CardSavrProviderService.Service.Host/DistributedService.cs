...
using Strivve.MS.CardSavrProviderService.Data.Validations;
using System;
using System.Threading.Tasks;

namespace Strivve.MS.CardSavrProviderService.Service.Host
{
    public class DistributedService : ProviderBasedService<ICardSavrProviderServiceServiceContract, ServiceImp>, ICardSavrProviderServiceServiceContract
    {
        private ICardSavrProviderServiceServiceContract _serviceContract; //This doesn't need to be injected, since the service will ALWAYS run the instance
