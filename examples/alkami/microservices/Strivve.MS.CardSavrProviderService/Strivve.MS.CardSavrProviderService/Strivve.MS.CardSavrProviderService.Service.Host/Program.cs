...
namespace Strivve.MS.CardSavrProviderService.Service.Host
{
    ...
    {
        private const string HostName = "Strivve.MS.CardSavrProviderService.Service.Host";
        ...
        private static void Main(string[] args)
        {
            ...
            HostFactory.Run(configurator =>
            {
                ...
                configurator.SetDescription("Strivve CardSavrProviderService");
                configurator.SetDisplayName("Strivve CardSavrProviderService");
